...
void test1(AdminUI& admin_ui) {
    ...
    admin_ui.add_product("A", 1111);
    admin_ui.add_product("B", 2222);
    admin_ui.add_product("C", 3333);
    admin_ui.add_product("D", 4444);
    admin_ui.add_product("E", 7777);
    admin_ui.list_products();
    admin_ui.edit_product("E", 5555);
    admin_ui.list_products();
...
void test2(ClientUI& client_ui) {
    ...
    client_ui.signup("Bob", "bob", false);
    client_ui.signup("David", "david", true);
    client_ui.signup("Emily", "emily", false);
    client_ui.signup("Alexa", "alexa", true);
    client_ui.signup("Chloe", "chloe", false);
    client_ui.login("Emily", "abc");
    client_ui.login("Emily", "emily");
    ...
    client_ui.buy_all_in_cart();
    client_ui.logout();
    client_ui.login("Chloe", "chloe");
    client_ui.buy("B");
    client_ui.add_to_cart("B");
    client_ui.add_to_cart("C");
    client_ui.add_to_cart("D");
    client_ui.add_to_cart("A");
    client_ui.add_to_cart("E");
    client_ui.buy_all_in_cart();
    client_ui.logout();
    client_ui.login("Bob", "bob");
    client_ui.buy("A");
    client_ui.buy("C");
    client_ui.buy("B");
    client_ui.logout();
    client_ui.login("Alexa", "alexa");
    client_ui.add_to_cart("B");
    client_ui.add_to_cart("B");
    client_ui.add_to_cart("C");
    client_ui.buy("A");
